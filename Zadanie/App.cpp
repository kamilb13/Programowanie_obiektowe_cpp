...
public:
    Kwadratowka() : wxFrame(NULL, wxID_ANY, "Wyznaczanie pierwiastków"){
        ...
        sizer->Add(labelB, 0, wxALL, 3);
        sizer->Add(poleB, 0, wxALL, 3);

        wxStaticText* labelC = new wxStaticText(panel, wxID_ANY, "Wspó³czynnik c:");
        poleC = new wxTextCtrl(panel, wxID_ANY);
        sizer->Add(labelC, 0, wxALL, 3);
        sizer->Add(poleC, 0, wxALL, 3);

        wxButton* wyznaczBtn = new wxButton(panel, wxID_ANY, "Oblicz");
        sizer->Add(wyznaczBtn, 0, wxALL, 3);
        ...
        sizer->Add(wynikLabel, 0, wxALL, 3);
        sizer->Add(wynikText, 0, wxALL, 3);
...
public:
    bool OnInit(){
        Kwadratowka* kwadratowka = new Kwadratowka();
        kwadratowka->SetClientSize(500, 450);
        kwadratowka->Show(true);
        return true;
    }
};
